...
function mostrarCompletadas() {
    ...
    tareas.forEach(tarea => {
        if (tarea.classList.contains("completed")) {
            ...
            tarea.style.display = "none"; //none oculta el elemento
        }
    })
}
...
// Agregar evento de clic al botón "Mostrar Tareas Completadas"
document.getElementById("mostrarCompletadas").addEventListener("click", mostrarCompletadas);

// Agregar evento de clic al botón "Mostrar Tareas Pendientes"
